    ...
    function (e, t, n) {
                    ...
                    t
                        ...
                        _(this.node.pnls, ".mm-panel").forEach((t) => {
                            t.classList.add(...i),
                                ...
                                t !== n &&
                                    t.classList.remove("mm-panel--highest"),
                                t === e
                ...
                ["htmllielement"].includes(o(e)) &&
                    (e.matches(".mm-listitem") ||
                        ...
                        e.matches(".mm-divider") ||
                            ...
                            _(e, this.conf.panelNodetype.join(", ")).forEach(
                                (e) => {
                                    this._initSubPanel(e);
                                }
                            ),
            ...
            if (void 0 !== e && (e instanceof Array || (e = [e]), e.length)) {
                ...
                e.forEach((e) => {
                    ...
                    this.bind("initMenu:after", () => {
                        for (let e in t)
                            this.node.pnls["bottom" == e ? "after" : "before"](
                                t[e]
                            );
                    });
            }
                ...
                e.append(t),
                    this.bind("initNavbar:after", (e) => {
                        if (!e.querySelector(".mm-navbar__breadcrumbs")) {
                            ...
                            for (
                                var t = [],
                                    n = g("span.mm-navbar__breadcrumbs"),
                                    s = e,
                                    i = !0;
                                s;
                            ...
                            this.conf.navbars.breadcrumbs.removeFirst &&
                                t.shift(),
                                (n.innerHTML = t.join(
                                    '<span class="mm-separator">' +
                                        this.conf.navbars.breadcrumbs
                                            .separator +
                                        "</span>"
                                )),
        ...
        const te = function () {
            ...
            ne = function (e) {
                ...
                if (
                    t.noResults.length &&
                    !L(e, ".mm-panel__noresults").length
                ) {
                ...
                if (n.cancel && e) {
                    ...
                    (e.href = "#"),
                        ...
                        e.addEventListener("click", (e) => {
                            e.preventDefault(),
                                this.closePanel(
                                    _(this.node.pnls, ".mm-panel--search")[0],
                                    !1
                                );
                        });
                }
            ...
            ie = function (e) {
                const t = this.opts.searchfield,
                    n =
                        e.closest(".mm-panel") ||
                        L(this.node.pnls, ".mm-panel--search")[0],
                    s = L(e, "input")[0];
                ...
                const a = () => {
                    ...
                    if (
                        ...
                        let t = 0;
                        (t = n.matches(".mm-panel--search")
                            ? ae(n, a, i)
                            : re(a, i)),
                            n.classList[0 == t ? "add" : "remove"](
                                "mm-panel--noresults"
                            ),
                        ...
                        this.trigger("clear:before"),
                            ...
                            n.matches(".mm-panel--search")
                                ? (oe(n),
                                  t.splash || this.closePanel(n, !1, !1))
                                : le(i),
